...
__author__ = ["leandrepi"]
__all__ = ["MultiRocketMultivariateCython"]


class MultiRocketMultivariateCython(BaseTransformer):
    """Multi RandOm Convolutional KErnel Transform (MultiRocket), Cython backend.
    ...
    Examples
    --------
     >>> from sktime.transformations.rocket import MultiRocketMultivariateCython
     ...
     >>> trf = MultiRocketMultivariateCython(num_kernels=512) # doctest: +SKIP
    ...
    def _fit(self, X, y=None):
        ...
        self
        """
        from sktime_cython.transformations.rocket._multirocket import multirocket_fit

        self.parameter, self.parameter1 = multirocket_fit(
            X,
            self.num_kernels,
    ...
    def _transform(self, X, y=None):
        ...
        return pd.DataFrame(
            multirocket_transform(
                X,
                (self.parameter, self.parameter1),
